...
export default {
    ...
    decorators: [
        (Story) => (
            <>
                <div className={'story_container'} style={{ display: 'inline-grid', minWidth: '225px' }}>
                    <Story />
                </div>
            </>
        ),
...
const RangeFilterStory = ({
    ...
    <>
        <h3>{title}</h3>
        <RangeFilter filterGroup={filterGroup} onChange={onChange} {...props} />
    </>
);
