...
import EntityStatistics, { DEFAULT_ENTITY_STATISTIC_DICTIONARY } from '.';
const statistic = {
    dataCategory: {
        data: [
            {
...
const dictionary = DEFAULT_ENTITY_STATISTIC_DICTIONARY;

describe('EntityStatistic', () => {
    test('make sure EntityStatistic render correctly', () => {
        const props = {
            dictionary,
            header: 'Header',
            id: 'entity-statistic',
