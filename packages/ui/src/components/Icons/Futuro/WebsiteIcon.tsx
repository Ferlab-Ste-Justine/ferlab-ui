        ...
        <g id="website">
            <g id="Group">
                ...
                <path
                    ...
                    id="Vector_2"
                />
                <path clipRule="evenodd" d="M4.5 7.5H3V6H4.5V7.5Z" fill="black" fillRule="evenodd" id="Vector_3" />
                <path clipRule="evenodd" d="M7.5 7.5H6V6H7.5V7.5Z" fill="black" fillRule="evenodd" id="Vector_4" />
                <path clipRule="evenodd" d="M10.5 7.5H9V6H10.5V7.5Z" fill="black" fillRule="evenodd" id="Vector_5" />
                <path
                    clipRule="evenodd"
                    ...
                    id="Vector_6"
                />
                <path clipRule="evenodd" d="M45 7.5H15V6H45V7.5Z" fill="black" fillRule="evenodd" id="Vector_7" />
                <path
                    clipRule="evenodd"
