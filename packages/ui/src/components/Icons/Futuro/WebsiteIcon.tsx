...
const WebsiteIcon = ({ className = '', height = 48, width = 48 }: IIconProps): JSX.Element => (
    <svg
        className={className}
        width={width}
        height={height}
        ...
        <g id="website">
            <g id="Group">
                ...
                <path
                    ...
                    fill="black"
                />
                <path id="Vector_3" fill-rule="evenodd" clip-rule="evenodd" d="M4.5 7.5H3V6H4.5V7.5Z" fill="black" />
                <path id="Vector_4" fill-rule="evenodd" clip-rule="evenodd" d="M7.5 7.5H6V6H7.5V7.5Z" fill="black" />
                <path id="Vector_5" fill-rule="evenodd" clip-rule="evenodd" d="M10.5 7.5H9V6H10.5V7.5Z" fill="black" />
                <path
                    id="Vector_6"
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    ...
                    fill="black"
                />
                <path id="Vector_7" fill-rule="evenodd" clip-rule="evenodd" d="M45 7.5H15V6H45V7.5Z" fill="black" />
                <path
                    id="Vector_8"
                    fill-rule="evenodd"
                    clip-rule="evenodd"
