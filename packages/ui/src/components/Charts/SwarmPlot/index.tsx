...
export type TSwarmPlotExtraProps = {
    data?: SwarmRawDatum[];
    selectedNode?: ComputedDatum<SwarmRawDatum>;
    groups?: string[];
    width?: number;
    height?: number;
    margin?: {
...
export type TSwarmPlotChart = Partial<Omit<SwarmPlotSvgProps<SwarmRawDatum>, 'data' | 'groups' | 'width' | 'height'>> &
...
const SwarmPlot = ({
    ...
    const range = useMemo(() => {
        ...
        return getRange({ data: [...data], margin: RANGE_MARGIN, selectedNode, zoom });
    }, [loading, data, zoom]);
                ...
                <div className={styles.chartWrapper}>
                    <div className={styles.chart}>
                        <ResponsiveSwarmPlot
                            ...
                            groups={groups}
                            margin={margin}
                            tooltip={(props) => <BasicTooltip id={props.id} />}
